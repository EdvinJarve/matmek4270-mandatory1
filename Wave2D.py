...
class Wave2D:
    ...
    def __call__(self, N, Nt, cfl=0.5, c=1.0, mx=3, my=3, store_data=-1):
        ...
        for n in range(1, Nt):
            ...
            self.Un[:] = self.Unp1
            if n % store_data == 0:
                self.plotdata[n] = self.Unm1.copy() # Unm1 is now swapped to Un
...
def create_animation():
    ...
    ani = animation.ArtistAnimation(fig, frames, interval=400, blit=True,
                                    repeat_delay=1000)
    ani.save('report/wavemovie2d.gif', writer='pillow', fps=5) # This animated png opens in a browser
